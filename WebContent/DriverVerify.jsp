...
<%
     ...
     String image1="image/"+aimg;
     String limg=request.getParameter("limg");
     String image2="image/"+limg;
%>
...
<div class="small-container single-product">
    <div class="row">
        <div class="col-2">
            <img src="<%=image %>" width="100%" id="ProductImg">
             <div class="small-img-row">
                ...
                <div class="small-img-col">
                    <img src="<%=image1 %>" width="100%" class="small-img"  >
                </div> <div class="small-img-col">
                    <img src="<%=image2 %>" width="100%" class="small-img" >
                </div><div class="small-img-col">
                    <img src="<%=image2 %>" width="100%" class="small-img" >
                </div>  
                  </div>
        ...
        <div class="col-2">
            ...
            <h1><b><%=name %></b></h1>
            <a href="Verified.jsp?id=<%=id %>&name=<%=name %>&age=<%=age %>&exp=<%=exp %>&city=<%=city %>&cont=<%=cont%>&dimg=<%=dimg%>&aimg=<%=aimg%>&limg=<%=limg%>"class="btn">Verify Driver</a>
            <a href="NotVerified?id=<%=id %>" class="btn">Not Verify</a>
